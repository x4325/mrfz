...
public class HarukaBulkFinale25 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkFinale25");

    public HarukaBulkFinale25() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkFinale25(); }
}
