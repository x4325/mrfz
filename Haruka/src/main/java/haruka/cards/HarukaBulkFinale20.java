...
public class HarukaBulkFinale20 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkFinale20");

    public HarukaBulkFinale20() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkFinale20(); }
}
