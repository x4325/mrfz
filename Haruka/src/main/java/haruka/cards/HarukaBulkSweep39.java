...
public class HarukaBulkSweep39 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkSweep39");

    public HarukaBulkSweep39() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkSweep39(); }
}
