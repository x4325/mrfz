...
public class HarukaBulkDraw48 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkDraw48");

    public HarukaBulkDraw48() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkDraw48(); }
}
