...
public class HarukaBulkFinale15 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkFinale15");

    public HarukaBulkFinale15() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkFinale15(); }
}
