...
public class HarukaBulkFinale40 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkFinale40");

    public HarukaBulkFinale40() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkFinale40(); }
}
