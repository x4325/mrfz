...
public class HarukaBulkDraw33 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkDraw33");

    public HarukaBulkDraw33() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkDraw33(); }
}
