...
public class HarukaBulkDraw18 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkDraw18");

    public HarukaBulkDraw18() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkDraw18(); }
}
