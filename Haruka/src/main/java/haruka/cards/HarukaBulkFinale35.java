...
public class HarukaBulkFinale35 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkFinale35");

    public HarukaBulkFinale35() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkFinale35(); }
}
