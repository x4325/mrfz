...
public class HarukaBulkSweep09 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkSweep09");

    public HarukaBulkSweep09() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkSweep09(); }
}
