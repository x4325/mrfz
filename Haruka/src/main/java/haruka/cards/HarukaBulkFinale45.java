...
public class HarukaBulkFinale45 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkFinale45");

    public HarukaBulkFinale45() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkFinale45(); }
}
