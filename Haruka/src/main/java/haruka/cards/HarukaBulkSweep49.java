...
public class HarukaBulkSweep49 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkSweep49");

    public HarukaBulkSweep49() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkSweep49(); }
}
