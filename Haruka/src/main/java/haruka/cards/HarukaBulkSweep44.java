...
public class HarukaBulkSweep44 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkSweep44");

    public HarukaBulkSweep44() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkSweep44(); }
}
