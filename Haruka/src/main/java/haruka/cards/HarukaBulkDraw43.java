...
public class HarukaBulkDraw43 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkDraw43");

    public HarukaBulkDraw43() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkDraw43(); }
}
