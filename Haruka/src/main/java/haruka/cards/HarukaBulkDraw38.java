...
public class HarukaBulkDraw38 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkDraw38");

    public HarukaBulkDraw38() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkDraw38(); }
}
