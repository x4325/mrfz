...
public class HarukaBulkSweep19 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkSweep19");

    public HarukaBulkSweep19() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkSweep19(); }
}
