...
public class HarukaBulkSweep29 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkSweep29");

    public HarukaBulkSweep29() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkSweep29(); }
}
