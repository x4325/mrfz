...
public class HarukaBulkDraw28 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkDraw28");

    public HarukaBulkDraw28() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkDraw28(); }
}
