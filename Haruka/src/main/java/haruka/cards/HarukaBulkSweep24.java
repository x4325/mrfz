...
public class HarukaBulkSweep24 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkSweep24");

    public HarukaBulkSweep24() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkSweep24(); }
}
