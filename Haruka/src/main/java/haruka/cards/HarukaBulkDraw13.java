...
public class HarukaBulkDraw13 extends AbstractHarukaCard {
    public static final String ID = HarukaMod.makeID("BulkDraw13");

    public HarukaBulkDraw13() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaBulkDraw13(); }
}
