#!/usr/bin/env python3
"""Generate placeholder grey PNGs for haruka (M1). User replaces card/event art later.
Image layout mirrors Eyjafjalla/Muelsyse: img/ (512,1024,char,charSelect,orbs,cards,relics)."""
from pathlib import Path
from PIL import Image, ImageDraw

ROOT = Path(r"G:\SteamLibrary\steamapps\workshop\content\646570\Haruka\src\main\resources\harukaResources\img")
GREY = (90, 90, 95)
