...
public class NymphHeartDoor extends AbstractImageEvent {
    public static final String ID = NymphMod.makeID("HeartDoor");

    public NymphHeartDoor() {
        super(
                CardCrawlGame.languagePack.getEventString(ID).NAME,
                CardCrawlGame.languagePack.getEventString(ID).DESCRIPTIONS[0],
                NymphMod.imgPath("events/HeartDoor.png"));
