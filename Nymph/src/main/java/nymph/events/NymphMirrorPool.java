...
public class NymphMirrorPool extends AbstractImageEvent {
    public static final String ID = NymphMod.makeID("MirrorPool");

    public NymphMirrorPool() {
        super(
                CardCrawlGame.languagePack.getEventString(ID).NAME,
                CardCrawlGame.languagePack.getEventString(ID).DESCRIPTIONS[0],
                NymphMod.imgPath("events/MirrorPool.png"));
