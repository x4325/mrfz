...
public class NymphBulkDraw23 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkDraw23");

    public NymphBulkDraw23() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkDraw23(); }
}
