...
public class NymphBulkStrike11 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkStrike11");

    public NymphBulkStrike11() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkStrike11(); }
}
