...
public class NymphHexBolt extends AbstractNymphCard {
    ...
    public void upgrade() {
        if (!upgraded) {
            upgradeName(); upgradeDamage(2); upgradeMagicNumber(1);
        }
    }

    @Override
    public AbstractCard makeCopy() { return new NymphHexBolt(); }
}
