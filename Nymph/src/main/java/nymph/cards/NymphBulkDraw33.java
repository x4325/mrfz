...
public class NymphBulkDraw33 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkDraw33");

    public NymphBulkDraw33() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkDraw33(); }
}
