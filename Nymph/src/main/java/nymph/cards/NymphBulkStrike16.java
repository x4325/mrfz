...
public class NymphBulkStrike16 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkStrike16");

    public NymphBulkStrike16() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkStrike16(); }
}
