...
public class NymphBulkFinale40 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkFinale40");

    public NymphBulkFinale40() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkFinale40(); }
}
