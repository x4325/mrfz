...
public class NymphBulkFinale25 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkFinale25");

    public NymphBulkFinale25() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkFinale25(); }
}
