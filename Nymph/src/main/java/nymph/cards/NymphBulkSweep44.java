...
public class NymphBulkSweep44 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkSweep44");

    public NymphBulkSweep44() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkSweep44(); }
}
