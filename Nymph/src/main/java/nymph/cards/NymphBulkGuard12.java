...
public class NymphBulkGuard12 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkGuard12");

    public NymphBulkGuard12() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkGuard12(); }
}
