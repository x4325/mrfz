...
public class NymphBulkGuard32 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkGuard32");

    public NymphBulkGuard32() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkGuard32(); }
}
