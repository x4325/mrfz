...
public class NymphBulkStrike41 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkStrike41");

    public NymphBulkStrike41() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkStrike41(); }
}
