...
public class NymphBulkSweep24 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkSweep24");

    public NymphBulkSweep24() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkSweep24(); }
}
