...
public class NymphBulkDraw28 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkDraw28");

    public NymphBulkDraw28() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkDraw28(); }
}
