...
public class NymphBulkGuard42 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkGuard42");

    public NymphBulkGuard42() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkGuard42(); }
}
