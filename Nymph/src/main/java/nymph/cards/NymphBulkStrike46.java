...
public class NymphBulkStrike46 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkStrike46");

    public NymphBulkStrike46() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkStrike46(); }
}
