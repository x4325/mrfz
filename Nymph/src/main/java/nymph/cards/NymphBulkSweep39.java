...
public class NymphBulkSweep39 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkSweep39");

    public NymphBulkSweep39() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkSweep39(); }
}
