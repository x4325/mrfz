...
public class NymphBulkGuard27 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkGuard27");

    public NymphBulkGuard27() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkGuard27(); }
}
