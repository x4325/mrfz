...
public class NymphBulkDraw18 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkDraw18");

    public NymphBulkDraw18() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkDraw18(); }
}
