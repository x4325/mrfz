...
public class NymphBulkStrike31 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkStrike31");

    public NymphBulkStrike31() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkStrike31(); }
}
