...
public class NymphBulkDraw48 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkDraw48");

    public NymphBulkDraw48() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkDraw48(); }
}
