...
public class NymphBulkStrike26 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkStrike26");

    public NymphBulkStrike26() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkStrike26(); }
}
