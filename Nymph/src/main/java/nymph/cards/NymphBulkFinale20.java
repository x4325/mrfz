...
public class NymphBulkFinale20 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkFinale20");

    public NymphBulkFinale20() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkFinale20(); }
}
