...
/** 咒缚连结 */
public class NymphHexLink extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("HexLink");
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphHexLink(); }
}
