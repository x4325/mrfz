...
public class NymphBulkFinale45 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkFinale45");

    public NymphBulkFinale45() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkFinale45(); }
}
