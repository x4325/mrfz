...
public class NymphBulkSweep34 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkSweep34");

    public NymphBulkSweep34() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkSweep34(); }
}
