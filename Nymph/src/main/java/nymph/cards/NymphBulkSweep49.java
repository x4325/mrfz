...
public class NymphBulkSweep49 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkSweep49");

    public NymphBulkSweep49() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkSweep49(); }
}
