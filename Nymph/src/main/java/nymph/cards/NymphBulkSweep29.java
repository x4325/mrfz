...
public class NymphBulkSweep29 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkSweep29");

    public NymphBulkSweep29() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkSweep29(); }
}
