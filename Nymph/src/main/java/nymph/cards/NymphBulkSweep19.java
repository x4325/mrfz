...
public class NymphBulkSweep19 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkSweep19");

    public NymphBulkSweep19() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkSweep19(); }
}
