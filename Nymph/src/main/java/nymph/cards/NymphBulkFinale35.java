...
public class NymphBulkFinale35 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkFinale35");

    public NymphBulkFinale35() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkFinale35(); }
}
