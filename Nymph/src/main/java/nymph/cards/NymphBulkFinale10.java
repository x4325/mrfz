...
public class NymphBulkFinale10 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkFinale10");

    public NymphBulkFinale10() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkFinale10(); }
}
