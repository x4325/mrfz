...
public class NymphBulkSweep09 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkSweep09");

    public NymphBulkSweep09() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkSweep09(); }
}
