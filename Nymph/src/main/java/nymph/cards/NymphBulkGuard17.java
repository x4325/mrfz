...
public class NymphBulkGuard17 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkGuard17");

    public NymphBulkGuard17() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkGuard17(); }
}
