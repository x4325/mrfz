...
public class NymphBulkGuard22 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkGuard22");

    public NymphBulkGuard22() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkGuard22(); }
}
