...
public class NymphBulkDraw43 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkDraw43");

    public NymphBulkDraw43() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkDraw43(); }
}
