...
public class NymphBulkGuard47 extends AbstractNymphCard {
    public static final String ID = NymphMod.makeID("BulkGuard47");

    public NymphBulkGuard47() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphBulkGuard47(); }
}
