...
public class SceneBulkDraw38 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkDraw38");

    public SceneBulkDraw38() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkDraw38(); }
}
