...
public class SceneBulkSweep44 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkSweep44");

    public SceneBulkSweep44() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkSweep44(); }
}
