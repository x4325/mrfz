...
public class SceneBulkDraw23 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkDraw23");

    public SceneBulkDraw23() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkDraw23(); }
}
