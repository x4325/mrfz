...
public class SceneBulkFinale45 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkFinale45");

    public SceneBulkFinale45() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkFinale45(); }
}
