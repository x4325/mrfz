...
public class SceneBulkDraw13 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkDraw13");

    public SceneBulkDraw13() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkDraw13(); }
}
