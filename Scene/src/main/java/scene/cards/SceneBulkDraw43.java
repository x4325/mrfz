...
public class SceneBulkDraw43 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkDraw43");

    public SceneBulkDraw43() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkDraw43(); }
}
