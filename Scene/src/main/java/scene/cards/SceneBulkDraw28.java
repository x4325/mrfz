...
public class SceneBulkDraw28 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkDraw28");

    public SceneBulkDraw28() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkDraw28(); }
}
