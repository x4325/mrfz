...
public class SceneBulkSweep39 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkSweep39");

    public SceneBulkSweep39() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkSweep39(); }
}
