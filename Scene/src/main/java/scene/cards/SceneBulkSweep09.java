...
public class SceneBulkSweep09 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkSweep09");

    public SceneBulkSweep09() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkSweep09(); }
}
