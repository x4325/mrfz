...
public class SceneBulkFinale40 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkFinale40");

    public SceneBulkFinale40() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkFinale40(); }
}
