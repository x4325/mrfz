...
public class SceneBulkDraw33 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkDraw33");

    public SceneBulkDraw33() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkDraw33(); }
}
