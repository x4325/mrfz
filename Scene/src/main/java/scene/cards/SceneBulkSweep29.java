...
public class SceneBulkSweep29 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkSweep29");

    public SceneBulkSweep29() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkSweep29(); }
}
