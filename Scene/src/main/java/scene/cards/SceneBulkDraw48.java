...
public class SceneBulkDraw48 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkDraw48");

    public SceneBulkDraw48() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkDraw48(); }
}
