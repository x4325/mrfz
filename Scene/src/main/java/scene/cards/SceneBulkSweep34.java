...
public class SceneBulkSweep34 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkSweep34");

    public SceneBulkSweep34() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkSweep34(); }
}
