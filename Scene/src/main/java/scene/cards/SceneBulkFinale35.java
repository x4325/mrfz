...
public class SceneBulkFinale35 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkFinale35");

    public SceneBulkFinale35() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkFinale35(); }
}
