...
public class SceneBulkSweep14 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkSweep14");

    public SceneBulkSweep14() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkSweep14(); }
}
