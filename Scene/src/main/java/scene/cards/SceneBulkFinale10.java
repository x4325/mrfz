...
public class SceneBulkFinale10 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkFinale10");

    public SceneBulkFinale10() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkFinale10(); }
}
