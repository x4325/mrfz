...
public class SceneBulkSweep19 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkSweep19");

    public SceneBulkSweep19() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkSweep19(); }
}
