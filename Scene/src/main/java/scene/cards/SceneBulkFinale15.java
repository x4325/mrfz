...
public class SceneBulkFinale15 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkFinale15");

    public SceneBulkFinale15() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkFinale15(); }
}
