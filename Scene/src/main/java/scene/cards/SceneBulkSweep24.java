...
public class SceneBulkSweep24 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkSweep24");

    public SceneBulkSweep24() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkSweep24(); }
}
