...
public class SceneBulkFinale20 extends AbstractSceneCard {
    public static final String ID = SceneMod.makeID("BulkFinale20");

    public SceneBulkFinale20() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneBulkFinale20(); }
}
