...
public class BulkRelic01 extends CustomRelic {
    public static final String ID = SceneMod.makeID("BulkRelic01");

    public BulkRelic01() {
        super(ID, new Texture(SceneMod.relicPath("BulkRelic01.png")),
                new Texture(SceneMod.relicOutlinePath("BulkRelic01.png")), RelicTier.COMMON, LandingSound.SOLID);
    }
