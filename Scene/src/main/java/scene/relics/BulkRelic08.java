...
public class BulkRelic08 extends CustomRelic {
    public static final String ID = SceneMod.makeID("BulkRelic08");

    public BulkRelic08() {
        super(ID, new Texture(SceneMod.relicPath("BulkRelic08.png")),
                new Texture(SceneMod.relicOutlinePath("BulkRelic08.png")), RelicTier.RARE, LandingSound.SOLID);
    }
