...
public class BulkRelic11 extends CustomRelic {
    public static final String ID = SceneMod.makeID("BulkRelic11");

    public BulkRelic11() {
        super(ID, new Texture(SceneMod.relicPath("BulkRelic11.png")),
                new Texture(SceneMod.relicOutlinePath("BulkRelic11.png")), RelicTier.BOSS, LandingSound.HEAVY);
    }
