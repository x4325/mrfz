...
public class SceneBrokenShutter extends AbstractImageEvent {
    public static final String ID = SceneMod.makeID("BrokenShutter");

    public SceneBrokenShutter() {
        super(
                CardCrawlGame.languagePack.getEventString(ID).NAME,
                CardCrawlGame.languagePack.getEventString(ID).DESCRIPTIONS[0],
                SceneMod.imgPath("events/BrokenShutter.png"));
    ...
    protected void buttonEffect(int buttonPressed) {
        ...
        switch (buttonPressed) {
            case 0:
                ...
                break;
            case 1:
                AbstractDungeon.player.heal(AbstractDungeon.player.maxHealth); AbstractDungeon.player.loseGold(AbstractDungeon.player.gold);
