...
public class Scene extends CustomPlayer {

    public static final String ID = SceneMod.makeID("Scene");
    ...
    public static final String[] orbTextures = new String[] {
        SceneMod.imgPath("orbs/1.png"),  // baseLayer
        SceneMod.imgPath("orbs/2.png"), SceneMod.imgPath("orbs/3.png"),
        SceneMod.imgPath("orbs/4.png"), SceneMod.imgPath("orbs/5.png"),
        SceneMod.imgPath("orbs/6.png"), SceneMod.imgPath("orbs/1.png"),
        SceneMod.imgPath("orbs/2.png"), SceneMod.imgPath("orbs/3.png"),
        SceneMod.imgPath("orbs/4.png"), SceneMod.imgPath("orbs/5.png"),
    };
    public static final String VFX = SceneMod.imgPath("orbs/6.png");
    ...
    public static final String IMG_SHOULDER = SceneMod.imgPath("char/char_shoulder.png");

    private static final String SPINE_ATLAS = SceneMod.imgPath("char/idle/char_336_folivo.atlas");
    private static final String SPINE_JSON = SceneMod.imgPath("char/idle/char_336_folivo.json");
    ...
    public Scene(String name) {
        ...
        super(name, ClassEnum.SCENE, orbTextures, VFX, LAYER_SPEED, null, null);
    ...
    @Override
        ...
        d.add(SceneStrike.ID); d.add(SceneStrike.ID); d.add(SceneStrike.ID); d.add(SceneStrike.ID);
        d.add(SceneDefend.ID); d.add(SceneDefend.ID); d.add(SceneDefend.ID); d.add(SceneDefend.ID);
        d.add(SceneFocusShot.ID);
        d.add(SceneShutterGuard.ID);
        return d;
    }
    ...
    @Override
    public AbstractCard.CardColor getCardColor() { return ColorEnum.SCENE_COLOR; }

    @Override
    public AbstractCard getStartCardForEvent() { return new SceneStrike(); }

    @Override
    public Color getCardRenderColor() { return new Color(0.55f,0.65f,0.80f, 1.0f); }

    @Override
    public Color getCardTrailColor() { return new Color(0.55f,0.65f,0.80f, 1.0f); }
    ...
    @Override
    public String getLocalizedCharacterName() { return name(0, "稀音"); }

    public static String getStaticLocalizedCharacterName() { return name(0, "稀音"); }

    public static String getStaticFlavorText() { return text(0, "战场摄影师，以镜头无人机忠实记录一切。"); }

    @Override
    public AbstractPlayer newInstance() { return new Scene(name(0, "稀音")); }

    @Override
    public String getSpireHeartText() { return text(1, "你点燃了决心。"); }

    @Override
    public Color getSlashAttackColor() { return new Color(0.55f,0.65f,0.80f, 1.0f); }
    ...
    @Override
    public String getTitle(AbstractPlayer.PlayerClass playerClass) { return name(1, "摄影师"); }

    @Override
    public String getPortraitImageName() { return SceneMod.imgPath("char/char_shoulder.png"); }
