#!/usr/bin/env python3
"""Generate placeholder grey PNGs for scene (M1). User replaces card/event art later.
Image layout mirrors Eyjafjalla/Muelsyse: img/ (512,1024,char,charSelect,orbs,cards,relics)."""
from pathlib import Path
from PIL import Image, ImageDraw

ROOT = Path(r"G:\SteamLibrary\steamapps\workshop\content\646570\Scene\src\main\resources\sceneResources\img")
GREY = (90, 90, 95)
...
if __name__ == "__main__":
    ...
    solid("char/char_shoulder.png", 1920, 1136, "稀音")
    solid("char/char_shoulder2.png", 1920, 1136, "稀音")
    solid("char/corpse.png", 512, 512, "稀音")
    # charSelect
    solid("charSelect/button.png", 240, 240, "稀音")
    solid("charSelect/portrait.png", 480, 600, "稀音")
    ...
    sync_small_orb()
    print("scene placeholder images ok")
