# Build highmore.jar  (SFW character mod, deps: basemod + stslib)
$ErrorActionPreference = "Stop"
$JAVA_HOME = "C:\Program Files\Eclipse Adoptium\jdk-8.0.492.9-hotspot"
$STEAM = "G:\SteamLibrary\steamapps"
$PROJ = "$STEAM\workshop\content\646570\Highmore"
...
& "$JAVA_HOME\bin\jar.exe" cf "$MODS\highmore.jar" .
Pop-Location
Write-Host "Built: $MODS\highmore.jar ($((Get-Item "$MODS\highmore.jar").Length) bytes)"
