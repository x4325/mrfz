#!/usr/bin/env python3
"""Generate placeholder grey PNGs for highmore (M1). User replaces card/event art later.
Image layout mirrors Eyjafjalla/Muelsyse: img/ (512,1024,char,charSelect,orbs,cards,relics)."""
from pathlib import Path
from PIL import Image, ImageDraw

ROOT = Path(r"G:\SteamLibrary\steamapps\workshop\content\646570\Highmore\src\main\resources\highmoreResources\img")
GREY = (90, 90, 95)
...
if __name__ == "__main__":
    ...
    solid("char/char_shoulder.png", 1920, 1136, "海沫")
    solid("char/char_shoulder2.png", 1920, 1136, "海沫")
    solid("char/corpse.png", 512, 512, "海沫")
    # charSelect
    solid("charSelect/button.png", 240, 240, "海沫")
    solid("charSelect/portrait.png", 480, 600, "海沫")
    ...
    sync_small_orb()
    print("highmore placeholder images ok")
