...
public class Highmore extends CustomPlayer {

    public static final String ID = HighmoreMod.makeID("Highmore");
    ...
    public static final String[] orbTextures = new String[] {
        HighmoreMod.imgPath("orbs/1.png"),  // baseLayer
        HighmoreMod.imgPath("orbs/2.png"), HighmoreMod.imgPath("orbs/3.png"),
        HighmoreMod.imgPath("orbs/4.png"), HighmoreMod.imgPath("orbs/5.png"),
        HighmoreMod.imgPath("orbs/6.png"), HighmoreMod.imgPath("orbs/1.png"),
        HighmoreMod.imgPath("orbs/2.png"), HighmoreMod.imgPath("orbs/3.png"),
        HighmoreMod.imgPath("orbs/4.png"), HighmoreMod.imgPath("orbs/5.png"),
    };
    public static final String VFX = HighmoreMod.imgPath("orbs/6.png");
    ...
    public static final String IMG_SHOULDER = HighmoreMod.imgPath("char/char_shoulder.png");

    private static final String SPINE_ATLAS = HighmoreMod.imgPath("char/idle/char_4066_highmo.atlas");
    private static final String SPINE_JSON = HighmoreMod.imgPath("char/idle/char_4066_highmo.json");
    ...
    public Highmore(String name) {
        ...
        super(name, ClassEnum.HIGHMORE, orbTextures, VFX, LAYER_SPEED, null, null);
        dialogX = (drawX * Settings.scale) + 0 * Settings.scale;
        dialogY = (drawY * Settings.scale) + 240 * Settings.scale;
        initializeClass(
                null,
                HighmoreMod.imgPath("char/shoulder_skin0.png"),
                HighmoreMod.imgPath("char/shoulder_skin0.png"),
    ...
    private static com.badlogic.gdx.graphics.Texture shoulderTex(int skinIndex) {
        String path = HighmoreMod.imgPath("char/shoulder_skin" + skinIndex + ".png");
        ...
        if (tex == null) {
            try {
                ...
                tex = ImageMaster.loadImage(HighmoreMod.imgPath("char/shoulder_skin0.png"));
            }
            if (tex == null) {
                // 最终兜底：绝不让营火渲染拿到 null
    ...
    @Override
        ...
        d.add(HighmoreStrike.ID); d.add(HighmoreStrike.ID); d.add(HighmoreStrike.ID); d.add(HighmoreStrike.ID);
        d.add(HighmoreDefend.ID); d.add(HighmoreDefend.ID); d.add(HighmoreDefend.ID); d.add(HighmoreDefend.ID);
        d.add(HighmoreTideReap.ID);
        d.add(HighmoreScytheSwing.ID);
        return d;
    }
    ...
    @Override
    public AbstractCard.CardColor getCardColor() { return ColorEnum.HIGHMORE_COLOR; }

    @Override
    public AbstractCard getStartCardForEvent() { return new HighmoreStrike(); }

    @Override
    public Color getCardRenderColor() { return new Color(0.40f,0.70f,0.75f, 1.0f); }

    @Override
    public Color getCardTrailColor() { return new Color(0.40f,0.70f,0.75f, 1.0f); }
    ...
    @Override
    public String getLocalizedCharacterName() { return name(0, "海沫"); }

    public static String getStaticLocalizedCharacterName() { return name(0, "海沫"); }

    public static String getStaticFlavorText() { return text(0, "阿戈尔的远航者，禁疗而以收割自给。"); }

    @Override
    public AbstractPlayer newInstance() { return new Highmore(name(0, "海沫")); }

    @Override
    public String getSpireHeartText() { return text(1, "你点燃了决心。"); }

    @Override
    public Color getSlashAttackColor() { return new Color(0.40f,0.70f,0.75f, 1.0f); }
    ...
    @Override
    public String getTitle(AbstractPlayer.PlayerClass playerClass) { return name(1, "远航者"); }

    @Override
    public String getPortraitImageName() { return HighmoreMod.imgPath("char/char_shoulder.png"); }
