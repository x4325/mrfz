...
public class HighmoreBulkFinale25 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkFinale25");

    public HighmoreBulkFinale25() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkFinale25(); }
}
