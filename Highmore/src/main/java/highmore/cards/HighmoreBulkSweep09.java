...
public class HighmoreBulkSweep09 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkSweep09");

    public HighmoreBulkSweep09() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkSweep09(); }
}
