...
public class HighmoreBulkDraw18 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkDraw18");

    public HighmoreBulkDraw18() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkDraw18(); }
}
