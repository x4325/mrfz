...
public class HighmoreBulkFinale45 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkFinale45");

    public HighmoreBulkFinale45() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkFinale45(); }
}
