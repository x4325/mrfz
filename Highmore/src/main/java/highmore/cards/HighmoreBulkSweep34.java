...
public class HighmoreBulkSweep34 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkSweep34");

    public HighmoreBulkSweep34() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkSweep34(); }
}
