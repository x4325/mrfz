...
public class HighmoreBulkSweep39 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkSweep39");

    public HighmoreBulkSweep39() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkSweep39(); }
}
