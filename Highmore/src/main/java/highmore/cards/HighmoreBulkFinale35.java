...
public class HighmoreBulkFinale35 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkFinale35");

    public HighmoreBulkFinale35() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkFinale35(); }
}
