...
public class HighmoreBulkFinale10 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkFinale10");

    public HighmoreBulkFinale10() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkFinale10(); }
}
