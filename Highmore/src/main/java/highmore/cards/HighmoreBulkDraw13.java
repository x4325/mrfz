...
public class HighmoreBulkDraw13 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkDraw13");

    public HighmoreBulkDraw13() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkDraw13(); }
}
