...
public class HighmoreBulkSweep19 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkSweep19");

    public HighmoreBulkSweep19() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkSweep19(); }
}
