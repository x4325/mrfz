...
public class HighmoreBulkSweep29 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkSweep29");

    public HighmoreBulkSweep29() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkSweep29(); }
}
