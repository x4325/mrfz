...
public class HighmoreBulkFinale15 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkFinale15");

    public HighmoreBulkFinale15() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkFinale15(); }
}
