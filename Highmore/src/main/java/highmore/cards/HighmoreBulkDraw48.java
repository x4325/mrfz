...
public class HighmoreBulkDraw48 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkDraw48");

    public HighmoreBulkDraw48() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkDraw48(); }
}
