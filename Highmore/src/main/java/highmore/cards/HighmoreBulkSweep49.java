...
public class HighmoreBulkSweep49 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkSweep49");

    public HighmoreBulkSweep49() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkSweep49(); }
}
