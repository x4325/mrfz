...
public class HighmoreBulkDraw43 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkDraw43");

    public HighmoreBulkDraw43() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkDraw43(); }
}
