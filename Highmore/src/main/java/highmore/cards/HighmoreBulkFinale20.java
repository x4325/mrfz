...
public class HighmoreBulkFinale20 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkFinale20");

    public HighmoreBulkFinale20() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkFinale20(); }
}
