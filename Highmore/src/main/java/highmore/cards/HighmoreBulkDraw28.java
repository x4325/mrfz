...
public class HighmoreBulkDraw28 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkDraw28");

    public HighmoreBulkDraw28() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkDraw28(); }
}
