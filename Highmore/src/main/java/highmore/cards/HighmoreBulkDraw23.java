...
public class HighmoreBulkDraw23 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkDraw23");

    public HighmoreBulkDraw23() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkDraw23(); }
}
