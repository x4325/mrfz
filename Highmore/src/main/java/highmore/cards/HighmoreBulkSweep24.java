...
public class HighmoreBulkSweep24 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkSweep24");

    public HighmoreBulkSweep24() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkSweep24(); }
}
