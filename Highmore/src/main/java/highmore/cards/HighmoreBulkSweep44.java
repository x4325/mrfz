...
public class HighmoreBulkSweep44 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkSweep44");

    public HighmoreBulkSweep44() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkSweep44(); }
}
