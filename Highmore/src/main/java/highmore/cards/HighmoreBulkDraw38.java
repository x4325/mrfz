...
public class HighmoreBulkDraw38 extends AbstractHighmoreCard {
    public static final String ID = HighmoreMod.makeID("BulkDraw38");

    public HighmoreBulkDraw38() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreBulkDraw38(); }
}
