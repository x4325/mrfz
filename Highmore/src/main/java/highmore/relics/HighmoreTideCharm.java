...
public class HighmoreTideCharm extends CustomRelic {
    public static final String ID = HighmoreMod.makeID("HighmoreTideCharm");

    public HighmoreTideCharm() {
        super(ID, new Texture(HighmoreMod.relicPath("HighmoreTideCharm.png")),
                new Texture(HighmoreMod.relicOutlinePath("HighmoreTideCharm.png")), RelicTier.COMMON, LandingSound.CLINK);
    }
