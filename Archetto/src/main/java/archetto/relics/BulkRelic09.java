...
public class BulkRelic09 extends CustomRelic {
    public static final String ID = ArchettoMod.makeID("BulkRelic09");

    public BulkRelic09() {
        super(ID, new Texture(ArchettoMod.relicPath("BulkRelic09.png")),
                new Texture(ArchettoMod.relicOutlinePath("BulkRelic09.png")), RelicTier.SHOP, LandingSound.SOLID);
    }
