...
public class ArchettoBulkFinale35 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkFinale35");

    public ArchettoBulkFinale35() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkFinale35(); }
}
