...
public class ArchettoBulkSweep14 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkSweep14");

    public ArchettoBulkSweep14() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkSweep14(); }
}
