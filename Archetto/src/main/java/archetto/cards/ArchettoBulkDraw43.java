...
public class ArchettoBulkDraw43 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkDraw43");

    public ArchettoBulkDraw43() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkDraw43(); }
}
