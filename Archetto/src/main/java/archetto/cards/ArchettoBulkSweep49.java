...
public class ArchettoBulkSweep49 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkSweep49");

    public ArchettoBulkSweep49() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkSweep49(); }
}
