...
public class ArchettoBulkFinale20 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkFinale20");

    public ArchettoBulkFinale20() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkFinale20(); }
}
