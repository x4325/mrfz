...
public class ArchettoBulkDraw28 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkDraw28");

    public ArchettoBulkDraw28() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkDraw28(); }
}
