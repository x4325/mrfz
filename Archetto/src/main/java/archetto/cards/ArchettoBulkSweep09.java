...
public class ArchettoBulkSweep09 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkSweep09");

    public ArchettoBulkSweep09() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkSweep09(); }
}
