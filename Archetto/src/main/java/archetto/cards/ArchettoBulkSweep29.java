...
public class ArchettoBulkSweep29 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkSweep29");

    public ArchettoBulkSweep29() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkSweep29(); }
}
