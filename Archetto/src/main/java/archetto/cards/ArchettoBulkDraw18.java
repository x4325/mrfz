...
public class ArchettoBulkDraw18 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkDraw18");

    public ArchettoBulkDraw18() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkDraw18(); }
}
