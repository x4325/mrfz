...
public class ArchettoBulkSweep24 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkSweep24");

    public ArchettoBulkSweep24() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkSweep24(); }
}
