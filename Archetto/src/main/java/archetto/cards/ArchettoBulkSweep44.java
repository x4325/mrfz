...
public class ArchettoBulkSweep44 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkSweep44");

    public ArchettoBulkSweep44() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkSweep44(); }
}
