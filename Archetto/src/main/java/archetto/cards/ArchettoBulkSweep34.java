...
public class ArchettoBulkSweep34 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkSweep34");

    public ArchettoBulkSweep34() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkSweep34(); }
}
