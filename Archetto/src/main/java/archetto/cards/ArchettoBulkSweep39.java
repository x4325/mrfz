...
public class ArchettoBulkSweep39 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkSweep39");

    public ArchettoBulkSweep39() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkSweep39(); }
}
