...
public class ArchettoBulkFinale40 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkFinale40");

    public ArchettoBulkFinale40() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkFinale40(); }
}
