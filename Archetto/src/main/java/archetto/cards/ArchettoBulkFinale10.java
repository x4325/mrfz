...
public class ArchettoBulkFinale10 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkFinale10");

    public ArchettoBulkFinale10() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkFinale10(); }
}
