...
public class ArchettoBulkSweep19 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkSweep19");

    public ArchettoBulkSweep19() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkSweep19(); }
}
