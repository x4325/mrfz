...
public class ArchettoBulkFinale25 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkFinale25");

    public ArchettoBulkFinale25() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkFinale25(); }
}
