...
public class ArchettoBulkDraw23 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkDraw23");

    public ArchettoBulkDraw23() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkDraw23(); }
}
