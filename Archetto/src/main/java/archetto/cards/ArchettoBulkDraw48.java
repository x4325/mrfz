...
public class ArchettoBulkDraw48 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkDraw48");

    public ArchettoBulkDraw48() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkDraw48(); }
}
