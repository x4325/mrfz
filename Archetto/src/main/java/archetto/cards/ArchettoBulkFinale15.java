...
public class ArchettoBulkFinale15 extends AbstractArchettoCard {
    public static final String ID = ArchettoMod.makeID("BulkFinale15");

    public ArchettoBulkFinale15() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoBulkFinale15(); }
}
