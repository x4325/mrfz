...
public class ArchettoFanMail extends AbstractImageEvent {
    public static final String ID = ArchettoMod.makeID("FanMail");

    public ArchettoFanMail() {
        super(
                CardCrawlGame.languagePack.getEventString(ID).NAME,
                CardCrawlGame.languagePack.getEventString(ID).DESCRIPTIONS[0],
                ArchettoMod.imgPath("events/FanMail.png"));
    ...
    protected void buttonEffect(int buttonPressed) {
        ...
        switch (buttonPressed) {
            case 0:
                ...
                break;
            case 1:
                AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new AimPower(AbstractDungeon.player, 3), 3));
