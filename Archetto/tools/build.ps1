# Build archetto.jar  (SFW character mod, deps: basemod + stslib)
$ErrorActionPreference = "Stop"
$JAVA_HOME = "C:\Program Files\Eclipse Adoptium\jdk-8.0.492.9-hotspot"
$STEAM = "G:\SteamLibrary\steamapps"
$PROJ = "$STEAM\workshop\content\646570\Archetto"
...
& "$JAVA_HOME\bin\jar.exe" cf "$MODS\archetto.jar" .
Pop-Location
Write-Host "Built: $MODS\archetto.jar ($((Get-Item "$MODS\archetto.jar").Length) bytes)"
