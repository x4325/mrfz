#!/usr/bin/env python3
"""Generate placeholder grey PNGs for archetto (M1). User replaces card/event art later.
Image layout mirrors Eyjafjalla/Muelsyse: img/ (512,1024,char,charSelect,orbs,cards,relics)."""
from pathlib import Path
from PIL import Image, ImageDraw

ROOT = Path(r"G:\SteamLibrary\steamapps\workshop\content\646570\Archetto\src\main\resources\archettoResources\img")
GREY = (90, 90, 95)
...
def sync_small_orb():
    """卡牌描述 [E] 使用 char/small_orb.png，须与 orbs/1 一致。"""
    src = ROOT / "orbs/1.png"
...
if __name__ == "__main__":
    ...
    solid("char/char_shoulder.png", 1920, 1136, "空弦")
    solid("char/char_shoulder2.png", 1920, 1136, "空弦")
    solid("char/corpse.png", 512, 512, "空弦")
    # charSelect
    solid("charSelect/button.png", 240, 240, "空弦")
    solid("charSelect/portrait.png", 480, 600, "空弦")
    ...
    sync_small_orb()
    print("archetto placeholder images ok")
