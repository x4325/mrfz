...
public class ScenePregnancyDeliveryRelic extends AbstractArkNsfwRelic {
    public static final String ID = ArkNsfwMod.makeID("ScenePregnancyDeliveryRelic");

    public ScenePregnancyDeliveryRelic() {
    ...
    public CustomRelic makeCopy() {
        return new ScenePregnancyDeliveryRelic();
    }
}
