...
import arknsfw.cards.curses.muel.CloneResidueCard;
import arknsfw.helpers.ArkCharMechanicsHelper;
import arknsfw.potions.AbstractArkPotion;
import arknsfw.powers.muel.BubbleGagPower;

public class MuteFoamPotion extends AbstractArkPotion {
    public static final String ID = ArkNsfwMod.makeID("MuteFoamPotion");

    public MuteFoamPotion() {
    ...
    public void use(AbstractCreature target) {
        ...
        addToBot(new MakeTempCardInDiscardAction(new CloneResidueCard(), 1));
    }
