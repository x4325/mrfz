...
/** 平复呼吸：主动压制兴奋，对抗高潮失控。 */
public class ArchettoCalmBreath extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("ArchettoCalmBreath");

    public ArchettoCalmBreath() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoCalmBreath(); }
}
