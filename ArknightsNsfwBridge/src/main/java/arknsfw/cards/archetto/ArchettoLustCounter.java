...
/** 鸣弦·欲火反击 */
public class ArchettoLustCounter extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("ArchettoLustCounter");

    public ArchettoLustCounter() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoLustCounter(); }
}
