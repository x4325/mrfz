...
/** 羞耻发汗：兴奋换抽牌 */
public class ArchettoShameSweat extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("ArchettoShameSweat");

    public ArchettoShameSweat() {
    ...
    @Override
    public AbstractCard makeCopy() { return new ArchettoShameSweat(); }
}
