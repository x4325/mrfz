...
/** 熔心·敏感引爆 */
public class EyjaSenseDetonate extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("EyjaSenseDetonate");

    public EyjaSenseDetonate() {
    ...
    @Override
    public AbstractCard makeCopy() { return new EyjaSenseDetonate(); }
}
