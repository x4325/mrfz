...
/** 熔心·高潮转移 */
public class EyjaClimaxTransfer extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("EyjaClimaxTransfer");

    public EyjaClimaxTransfer() {
        super(ID, 1, CardType.SKILL, ColorEnum.Eyjafjalla_COLOR, CardRarity.RARE, CardTarget.ALL_ENEMY, "card_burn_mark.png");
    ...
    @Override
    public AbstractCard makeCopy() { return new EyjaClimaxTransfer(); }
}
