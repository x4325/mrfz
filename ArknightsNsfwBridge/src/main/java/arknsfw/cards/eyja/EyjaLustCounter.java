...
/** 熔心·欲火反击 */
public class EyjaLustCounter extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("EyjaLustCounter");

    public EyjaLustCounter() {
        super(ID, 1, CardType.ATTACK, ColorEnum.Eyjafjalla_COLOR, CardRarity.COMMON, CardTarget.ENEMY, "card_burn_mark.png");
        baseDamage = 8;
    ...
    @Override
    public AbstractCard makeCopy() { return new EyjaLustCounter(); }
}
