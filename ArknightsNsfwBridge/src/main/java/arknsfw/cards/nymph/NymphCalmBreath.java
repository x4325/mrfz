...
/** 平复呼吸：主动压制兴奋，对抗高潮失控。 */
public class NymphCalmBreath extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("NymphCalmBreath");

    public NymphCalmBreath() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphCalmBreath(); }
}
