...
/** 迷雾·敏感汲取 */
public class NymphSenseDrain extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("NymphSenseDrain");

    public NymphSenseDrain() {
    ...
    @Override
    public AbstractCard makeCopy() { return new NymphSenseDrain(); }
}
