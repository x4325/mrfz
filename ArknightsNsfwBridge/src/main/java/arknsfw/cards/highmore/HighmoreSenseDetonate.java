...
/** 幽潮·敏感引爆 */
public class HighmoreSenseDetonate extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("HighmoreSenseDetonate");

    public HighmoreSenseDetonate() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreSenseDetonate(); }
}
