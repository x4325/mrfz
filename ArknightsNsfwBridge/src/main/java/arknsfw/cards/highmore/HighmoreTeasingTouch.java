...
/** 幽潮·挑逗指尖 */
public class HighmoreTeasingTouch extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("HighmoreTeasingTouch");

    public HighmoreTeasingTouch() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreTeasingTouch(); }
}
