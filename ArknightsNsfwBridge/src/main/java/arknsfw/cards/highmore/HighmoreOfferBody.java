...
/** 献身防御：白嫖格挡换受孕 */
public class HighmoreOfferBody extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("HighmoreOfferBody");

    public HighmoreOfferBody() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HighmoreOfferBody(); }
}
