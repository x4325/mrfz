...
/** 羞耻发汗：兴奋换抽牌 */
public class HarukaShameSweat extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("HarukaShameSweat");

    public HarukaShameSweat() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaShameSweat(); }
}
