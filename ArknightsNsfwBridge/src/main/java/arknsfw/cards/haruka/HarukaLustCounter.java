...
/** 烬焰·欲火反击 */
public class HarukaLustCounter extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("HarukaLustCounter");

    public HarukaLustCounter() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaLustCounter(); }
}
