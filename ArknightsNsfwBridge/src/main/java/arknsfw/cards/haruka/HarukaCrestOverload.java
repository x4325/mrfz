...
/** 烬焰·淫纹过载 */
public class HarukaCrestOverload extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("HarukaCrestOverload");

    public HarukaCrestOverload() {
        super(ID, -1, CardType.ATTACK, ColorEnum.HARUKA_COLOR, CardRarity.RARE, CardTarget.ENEMY, "card_haruka_harukawarmembrace.png");
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaCrestOverload(); }
}
