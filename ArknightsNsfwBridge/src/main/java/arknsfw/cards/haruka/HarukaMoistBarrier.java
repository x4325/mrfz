...
public class HarukaMoistBarrier extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("HarukaMoistBarrier");

    public HarukaMoistBarrier() {
    ...
    @Override
    public AbstractCard makeCopy() { return new HarukaMoistBarrier(); }
}
