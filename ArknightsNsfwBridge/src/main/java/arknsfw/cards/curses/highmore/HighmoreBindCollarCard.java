...
public class HighmoreBindCollarCard extends AbstractArkCurseCard {
    public static final String ID = ArkNsfwMod.makeID("HighmoreBindCollarCard");

    public HighmoreBindCollarCard() {
        super(ID, "curse_highmore_highmorebindcollarcard.png");
    }
    ...
    @Override public AbstractCard makeCopy() { return new HighmoreBindCollarCard(); }
}
