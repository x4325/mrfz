...
public class SceneMoistBarrier extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("SceneMoistBarrier");

    public SceneMoistBarrier() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneMoistBarrier(); }
}
