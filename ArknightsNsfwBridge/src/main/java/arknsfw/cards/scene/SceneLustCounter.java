...
/** 留影·欲火反击 */
public class SceneLustCounter extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("SceneLustCounter");

    public SceneLustCounter() {
    ...
    @Override
    public AbstractCard makeCopy() { return new SceneLustCounter(); }
}
