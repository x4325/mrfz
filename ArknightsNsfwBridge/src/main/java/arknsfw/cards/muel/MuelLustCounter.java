...
/** 清漪·欲火反击 */
public class MuelLustCounter extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("MuelLustCounter");

    public MuelLustCounter() {
        super(ID, 1, CardType.ATTACK, ColorEnum.Muelsyse_COLOR, CardRarity.COMMON, CardTarget.ENEMY, "card_clone_haze.png");
        baseDamage = 8;
    ...
    @Override
    public AbstractCard makeCopy() { return new MuelLustCounter(); }
}
