...
/** 清漪·高潮转移 */
public class MuelClimaxTransfer extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("MuelClimaxTransfer");

    public MuelClimaxTransfer() {
        super(ID, 1, CardType.SKILL, ColorEnum.Muelsyse_COLOR, CardRarity.RARE, CardTarget.ALL_ENEMY, "card_clone_haze.png");
    ...
    @Override
    public AbstractCard makeCopy() { return new MuelClimaxTransfer(); }
}
