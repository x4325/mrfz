...
/** 清漪·敏感汲取 */
public class MuelSenseDrain extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("MuelSenseDrain");

    public MuelSenseDrain() {
    ...
    @Override
    public AbstractCard makeCopy() { return new MuelSenseDrain(); }
}
