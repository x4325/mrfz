...
/** 清漪·淫纹过载 */
public class MuelCrestOverload extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("MuelCrestOverload");

    public MuelCrestOverload() {
        super(ID, -1, CardType.ATTACK, ColorEnum.Muelsyse_COLOR, CardRarity.RARE, CardTarget.ENEMY, "card_moist_barrier.png");
    ...
    @Override
    public AbstractCard makeCopy() { return new MuelCrestOverload(); }
}
