...
/** 清漪·快感护壁 */
public class MuelPleasureShield extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("MuelPleasureShield");

    public MuelPleasureShield() {
    ...
    @Override
    public AbstractCard makeCopy() { return new MuelPleasureShield(); }
}
