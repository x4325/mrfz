...
/** 清漪·发情冲锋 */
public class MuelHeatCharge extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("MuelHeatCharge");

    public MuelHeatCharge() {
    ...
    @Override
    public AbstractCard makeCopy() { return new MuelHeatCharge(); }
}
