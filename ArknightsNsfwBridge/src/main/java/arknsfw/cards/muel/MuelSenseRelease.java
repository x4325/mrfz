...
/** 清漪·敏感解放 */
public class MuelSenseRelease extends AbstractArkNsfwCard {
    public static final String ID = ArkNsfwMod.makeID("MuelSenseRelease");

    public MuelSenseRelease() {
    ...
    @Override
    public AbstractCard makeCopy() { return new MuelSenseRelease(); }
}
