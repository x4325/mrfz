...
public class HarukaFallAct1Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("HarukaFallAct1");

    public HarukaFallAct1Event() {
        super(ID, ArkEventImages.path(ArkEventImages.HARUKA_FALL_ACT1), ArkRunProgress.Route.FALL, 3);
    }
