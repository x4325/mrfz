...
public class HarukaShameAct1Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("HarukaShameAct1");

    public HarukaShameAct1Event() {
        super(ID, ArkEventImages.path(ArkEventImages.HARUKA_SHAME_ACT1), ArkRunProgress.Route.SHAME, 3);
    }
