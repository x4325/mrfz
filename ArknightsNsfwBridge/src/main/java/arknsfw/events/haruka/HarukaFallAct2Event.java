...
public class HarukaFallAct2Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("HarukaFallAct2");

    public HarukaFallAct2Event() {
        super(ID, ArkEventImages.path(ArkEventImages.HARUKA_FALL_ACT2), ArkRunProgress.Route.FALL, 3);
    }
