...
public class HarukaNormalAct2Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("HarukaNormalAct2");

    public HarukaNormalAct2Event() {
        super(ID, ArkEventImages.path(ArkEventImages.HARUKA_NORMAL_ACT2), ArkRunProgress.Route.NORMAL, 3);
    }
