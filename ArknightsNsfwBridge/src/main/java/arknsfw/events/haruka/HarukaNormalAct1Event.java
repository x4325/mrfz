...
public class HarukaNormalAct1Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("HarukaNormalAct1");

    public HarukaNormalAct1Event() {
        super(ID, ArkEventImages.path(ArkEventImages.HARUKA_NORMAL_ACT1), ArkRunProgress.Route.NORMAL, 3);
    }
