...
public class HighmoreNormalAct2Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("HighmoreNormalAct2");

    public HighmoreNormalAct2Event() {
        super(ID, ArkEventImages.path(ArkEventImages.HIGHMORE_NORMAL_ACT2), ArkRunProgress.Route.NORMAL, 3);
    }
