...
public class HighmoreShameAct3Event extends AbstractArkFiveRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("HighmoreShameAct3");

    public HighmoreShameAct3Event() {
        super(ID, ArkEventImages.path(ArkEventImages.HIGHMORE_SHAME_ACT3), ArkRunProgress.Route.SHAME, 3);
    }
