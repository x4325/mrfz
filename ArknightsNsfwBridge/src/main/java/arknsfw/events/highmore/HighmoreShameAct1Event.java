...
public class HighmoreShameAct1Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("HighmoreShameAct1");

    public HighmoreShameAct1Event() {
        super(ID, ArkEventImages.path(ArkEventImages.HIGHMORE_SHAME_ACT1), ArkRunProgress.Route.SHAME, 3);
    }
