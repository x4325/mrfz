...
public class HighmoreFallAct2Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("HighmoreFallAct2");

    public HighmoreFallAct2Event() {
        super(ID, ArkEventImages.path(ArkEventImages.HIGHMORE_FALL_ACT2), ArkRunProgress.Route.FALL, 3);
    }
