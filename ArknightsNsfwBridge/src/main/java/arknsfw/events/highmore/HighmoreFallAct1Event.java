...
public class HighmoreFallAct1Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("HighmoreFallAct1");

    public HighmoreFallAct1Event() {
        super(ID, ArkEventImages.path(ArkEventImages.HIGHMORE_FALL_ACT1), ArkRunProgress.Route.FALL, 3);
    }
