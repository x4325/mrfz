...
public class HighmoreNormalAct1Event extends AbstractArkFiveRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("HighmoreNormalAct1");

    public HighmoreNormalAct1Event() {
        super(ID, ArkEventImages.path(ArkEventImages.HIGHMORE_NORMAL_ACT1), ArkRunProgress.Route.NORMAL, 1);
    }
