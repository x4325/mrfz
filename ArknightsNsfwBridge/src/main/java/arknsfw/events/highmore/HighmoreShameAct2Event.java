...
public class HighmoreShameAct2Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("HighmoreShameAct2");

    public HighmoreShameAct2Event() {
        super(ID, ArkEventImages.path(ArkEventImages.HIGHMORE_SHAME_ACT2), ArkRunProgress.Route.SHAME, 3);
    }
