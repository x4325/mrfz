...
public class ArchettoShameAct1Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("ArchettoShameAct1");

    public ArchettoShameAct1Event() {
        super(ID, ArkEventImages.path(ArkEventImages.ARCHETTO_SHAME_ACT1), ArkRunProgress.Route.SHAME, 3);
    }
