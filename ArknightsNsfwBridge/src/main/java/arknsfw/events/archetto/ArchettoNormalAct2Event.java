...
public class ArchettoNormalAct2Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("ArchettoNormalAct2");

    public ArchettoNormalAct2Event() {
        super(ID, ArkEventImages.path(ArkEventImages.ARCHETTO_NORMAL_ACT2), ArkRunProgress.Route.NORMAL, 3);
    }
