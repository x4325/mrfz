...
public class ArchettoFallAct1Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("ArchettoFallAct1");

    public ArchettoFallAct1Event() {
        super(ID, ArkEventImages.path(ArkEventImages.ARCHETTO_FALL_ACT1), ArkRunProgress.Route.FALL, 3);
    }
