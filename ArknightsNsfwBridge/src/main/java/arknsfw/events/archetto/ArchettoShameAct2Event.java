...
public class ArchettoShameAct2Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("ArchettoShameAct2");

    public ArchettoShameAct2Event() {
        super(ID, ArkEventImages.path(ArkEventImages.ARCHETTO_SHAME_ACT2), ArkRunProgress.Route.SHAME, 3);
    }
