...
public class ArchettoFallAct2Event extends AbstractArkFiveRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("ArchettoFallAct2");

    public ArchettoFallAct2Event() {
        super(ID, ArkEventImages.path(ArkEventImages.ARCHETTO_FALL_ACT2), ArkRunProgress.Route.FALL, 2);
    }
