...
public class ArchettoNormalAct1Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("ArchettoNormalAct1");

    public ArchettoNormalAct1Event() {
        super(ID, ArkEventImages.path(ArkEventImages.ARCHETTO_NORMAL_ACT1), ArkRunProgress.Route.NORMAL, 3);
    }
