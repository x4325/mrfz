...
public class EyjaFallAshWombEvent extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("EyjaFallAshWomb");

    public EyjaFallAshWombEvent() {
        super(ID, ArkEventImages.path(ArkEventImages.EYJA_FALL_ACT3), ArkRunProgress.Route.FALL, 4);
    }
    ...
    protected void onFirstChoice(int buttonUsed) {
        ...
        if (buttonUsed == 3) {
            ArkRouteDirtyOptionHelper.applyEyjaFallDirty(3);
            showResult(4);
        }
    }
}
