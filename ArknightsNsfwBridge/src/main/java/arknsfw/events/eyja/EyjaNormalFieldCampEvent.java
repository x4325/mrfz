...
public class EyjaNormalFieldCampEvent extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("EyjaNormalFieldCamp");

    public EyjaNormalFieldCampEvent() {
        super(ID, ArkEventImages.path(ArkEventImages.EYJA_NORMAL_ACT2), ArkRunProgress.Route.NORMAL, 4);
    }
