...
public class EyjaFallBreedingRiteEvent extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("EyjaFallBreedingRite");

    public EyjaFallBreedingRiteEvent() {
        super(ID, ArkEventImages.path(ArkEventImages.EYJA_FALL_ACT2), ArkRunProgress.Route.FALL, 4);
    }
    ...
    protected void onFirstChoice(int buttonUsed) {
        ...
        if (buttonUsed == 3) {
            ArkRouteDirtyOptionHelper.applyEyjaFallDirty(2);
            showResult(4);
        }
    }
}
