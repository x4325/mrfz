...
public class EyjaNormalVolcanoRestEvent extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("EyjaNormalVolcanoRest");

    public EyjaNormalVolcanoRestEvent() {
        super(ID, ArkEventImages.path(ArkEventImages.EYJA_NORMAL_ACT1), ArkRunProgress.Route.NORMAL, 4);
    }
    ...
    protected void onFirstChoice(int buttonUsed) {
        ...
        if (buttonUsed == 3) {
            ArkRouteDirtyOptionHelper.applyNormalWarmth(1);
            showResult(4);
        }
    }
}
