...
public class EyjaNormalQuietEmbraceEvent extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("EyjaNormalQuietEmbrace");

    public EyjaNormalQuietEmbraceEvent() {
        super(ID, ArkEventImages.path(ArkEventImages.EYJA_NORMAL_ACT3), ArkRunProgress.Route.NORMAL, 4);
    }
    ...
    protected void onFirstChoice(int buttonUsed) {
        ...
        if (buttonUsed == 3) {
            ArkRouteDirtyOptionHelper.applyNormalWarmth(3);
            showResult(4);
        }
    }
}
