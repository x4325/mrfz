...
public class MuelNormalStarPoolEvent extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("MuelNormalStarPool");

    public MuelNormalStarPoolEvent() {
        super(ID, ArkEventImages.path(ArkEventImages.MUEL_NORMAL_ACT3), ArkRunProgress.Route.NORMAL, 4);
    }
