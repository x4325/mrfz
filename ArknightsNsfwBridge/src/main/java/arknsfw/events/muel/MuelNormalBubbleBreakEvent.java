...
public class MuelNormalBubbleBreakEvent extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("MuelNormalBubbleBreak");

    public MuelNormalBubbleBreakEvent() {
        super(ID, ArkEventImages.path(ArkEventImages.MUEL_NORMAL_ACT1), ArkRunProgress.Route.NORMAL, 4);
    }
