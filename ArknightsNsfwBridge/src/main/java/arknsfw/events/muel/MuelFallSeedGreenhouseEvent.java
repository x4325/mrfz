...
public class MuelFallSeedGreenhouseEvent extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("MuelFallSeedGreenhouse");

    public MuelFallSeedGreenhouseEvent() {
        super(ID, ArkEventImages.path(ArkEventImages.MUEL_FALL_ACT2), ArkRunProgress.Route.FALL, 4);
    }
    ...
    protected void onFirstChoice(int buttonUsed) {
        ...
        if (buttonUsed == 3) {
            ArkRouteDirtyOptionHelper.applyMuelFallDirty(2);
            showResult(4);
        }
    }
}
