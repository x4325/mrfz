...
public class SceneNormalAct2Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("SceneNormalAct2");

    public SceneNormalAct2Event() {
        super(ID, ArkEventImages.path(ArkEventImages.SCENE_NORMAL_ACT2), ArkRunProgress.Route.NORMAL, 3);
    }
