...
public class SceneShameAct1Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("SceneShameAct1");

    public SceneShameAct1Event() {
        super(ID, ArkEventImages.path(ArkEventImages.SCENE_SHAME_ACT1), ArkRunProgress.Route.SHAME, 3);
    }
