...
public class SceneFallAct2Event extends AbstractArkFiveRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("SceneFallAct2");

    public SceneFallAct2Event() {
        super(ID, ArkEventImages.path(ArkEventImages.SCENE_FALL_ACT2), ArkRunProgress.Route.FALL, 2);
    }
