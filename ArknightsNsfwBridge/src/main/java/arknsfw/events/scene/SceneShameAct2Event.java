...
public class SceneShameAct2Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("SceneShameAct2");

    public SceneShameAct2Event() {
        super(ID, ArkEventImages.path(ArkEventImages.SCENE_SHAME_ACT2), ArkRunProgress.Route.SHAME, 3);
    }
