...
public class NymphShameAct2Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("NymphShameAct2");

    public NymphShameAct2Event() {
        super(ID, ArkEventImages.path(ArkEventImages.NYMPH_SHAME_ACT2), ArkRunProgress.Route.SHAME, 3);
    }
