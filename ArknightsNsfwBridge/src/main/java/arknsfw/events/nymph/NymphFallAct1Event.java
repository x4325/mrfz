...
public class NymphFallAct1Event extends AbstractArkFiveRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("NymphFallAct1");

    public NymphFallAct1Event() {
        super(ID, ArkEventImages.path(ArkEventImages.NYMPH_FALL_ACT1), ArkRunProgress.Route.FALL, 1);
    }
