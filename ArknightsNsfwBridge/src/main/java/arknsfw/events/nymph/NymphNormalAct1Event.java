...
public class NymphNormalAct1Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("NymphNormalAct1");

    public NymphNormalAct1Event() {
        super(ID, ArkEventImages.path(ArkEventImages.NYMPH_NORMAL_ACT1), ArkRunProgress.Route.NORMAL, 3);
    }
