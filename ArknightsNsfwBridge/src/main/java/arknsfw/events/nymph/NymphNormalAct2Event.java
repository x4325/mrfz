...
public class NymphNormalAct2Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("NymphNormalAct2");

    public NymphNormalAct2Event() {
        super(ID, ArkEventImages.path(ArkEventImages.NYMPH_NORMAL_ACT2), ArkRunProgress.Route.NORMAL, 3);
    }
