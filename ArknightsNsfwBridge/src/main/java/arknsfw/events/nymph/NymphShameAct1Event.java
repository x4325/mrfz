...
public class NymphShameAct1Event extends AbstractArkRouteEvent {
    public static final String ID = ArkNsfwMod.makeID("NymphShameAct1");

    public NymphShameAct1Event() {
        super(ID, ArkEventImages.path(ArkEventImages.NYMPH_SHAME_ACT1), ArkRunProgress.Route.SHAME, 3);
    }
